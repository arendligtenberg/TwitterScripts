...
APP_KEY = 'q1lbNsctLVbqxrNMqZdLs42iC'
APP_SECRET = 'ujir8AvdvvkiFouEtSYrr8cNGiOvGnp9XJQZuw9WCkVp7pgeeI'
OAUTH_TOKEN = '723073856894693376-9YXfz2ANi7WeOM2iOw4lxUeLhycIwn0'
OAUTH_TOKEN_SECRET = 'EeqjdmbE1bb9kMa3RH1NVWCNVOuW7osZZbplneiihqZWe'
...
class MyStreamer(TwythonStreamer):
    def on_success(self, data):
        ...
        if (tweet_lat != 0) or (place_lat !=0):
            ...
            cur.execute('INSERT INTO milltweets (tweet_id, tweet_datetime, tweet_text, latitude, longitude,tweet_name,retweet_count,place_lat,place_lon) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s);', (tweet_id, tweet_datetime, tweet_text, tweet_lat,tweet_lon,tweet_name,retweet_count,place_lat,place_lon))
            conn.commit()                                                                                                                                             
        else:
